...
public class RoomNumber_Type extends Annotation_Type {
  ...
  public int getIds(int addr) {
      ...
      jcas.throwFeatMissing("ids", "org.uimafit.examples.tutorial.type.RoomNumber");
    return ll_cas.ll_getIntValue(addr, casFeatCode_ids);
  }
  /** @generated */    
  public void setIds(int addr, int v) {
        if (featOkTst && casFeat_ids == null)
      jcas.throwFeatMissing("ids", "org.uimafit.examples.tutorial.type.RoomNumber");
    ll_cas.ll_setIntValue(addr, casFeatCode_ids, v);}
    ...
    casFeat_ids = jcas.getRequiredFeatureDE(casType, "ids", "uima.cas.Integer", featOkTst);
